...
def preprocess_dataset(dataset_path):
    ...
    num_classes = 8  # We have 26 classes (letters A to Z)
...
def main():
    train_path='Dataset/fkrvwxyz/training_set/'
    test_path='Dataset/fkrvwxyz/test_set/'
    ...
    model.save('hand_gesture_modelfkrvwxyz.h5')         
